...
def get_column_mapping_spec(
    ...
    return ColumnMappingResponse(
        description=(
            "Standard mapping for checklist Excel/CSV import with two header rows. "
            "Row 1 contains grouped labels, and row 2 contains the actual section and question-id subcolumn labels. "
            "This template uses the actual column names generated by the CSV parser for two-row header format. "
            "Guidance score columns are imported as answer option titles/labels for scores 4..1."
        ),
        required_columns=[
            "section_name_col",
            "question_id_col",
        ...
        example_format={
            ...
            "guidance_score_4": "Fully compliant",
            "guidance_score_3": "Mostly compliant",
            "guidance_score_2": "Partially compliant",
            "guidance_score_1": "Not compliant",
        },
    )
